...
const About = () => {
  useRevealAll();
  const { containerRef: contactRef, cursorRef: contactCursorRef } =
    useViewCursor();
      ...
      <section className="about-hero">
        <div className="about-hero-inner">
          ...
          <h1 className="about-h1">
            THE
            <br />
            <span className="about-h1-stroke">PHOTO</span>
            <br />
            GRAPHER
          </h1>
        </div>
        ...
        <div className="contact-inner">
          ...
          <div className="contact-grid" ref={contactRef}>
            <a
              ...
              className="contact-card reveal reveal-d1"
            >
            ...
            <a
              ...
              className="contact-card reveal reveal-d2"
            >
          ...
          <div className="contact-form-section reveal reveal-d2">
            ...
            <span className="contact-form-subtitle mono">
